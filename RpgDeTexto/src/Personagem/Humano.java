...
public class Humano extends Personagem {
	...
	public void criarPersonagem(String nome) {
		this.setNome(nome);
		this.setRaca("Humano");
		this.setArmaAtac("Espada");
		this.setArmaDefesa("Escudo");
		this.setVida(100);
		this.setDanoArma(5);
		this.setCuraVida(2);
		this.setPorcao(0);
	...
	public void statusPersonagem() {
		...
		System.out.println(
				"Ao atacar com a " + getArmaAtac() + " é causado um dano de -" + this.getDanoArma() + " no adversário");
